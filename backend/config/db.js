...
logger.debug(
  `db.js: DB Config User: ${dbConfig.user}, Host: ${dbConfig.host}, DB: ${dbConfig.database}, Port: ${dbConfig.port}`
);
logger.debug(
  `db.js: DATABASE_PASSWORD is ${process.env.DATABASE_PASSWORD ? 'set' : 'NOT set'}`
);
